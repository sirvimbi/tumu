                ...
                children: [
                            ...
                            children: [
                              Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROPERTY_DETAILS_OWNER_Image_icilkwqs_ON');
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PROPERTY_DETAILS_OWNER_Card_zte9jvd8_ON_');
                                            logFirebaseEvent(
                                                'Card_navigate_back');
                                            context.pop();
                                          },
                                          child: Card(
                                            ...
                                            child: FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'PROPERTY_DETAILS_OWNER_arrow_back_rounde');
                                                logFirebaseEvent(
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'PROPERTY_DETAILS_OWNER_ratingBar_ON_TAP');
              ...
              child: Row(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PROPERTY_DETAILS_OWNER_EDIT_PROPERTY_BTN');
