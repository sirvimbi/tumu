    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('EDIT_PROPERTY_1_arrow_back_rounded_ICN_O');
                      ...
                      child: Column(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'EDIT_PROPERTY_1_PAGE_uploadImage_ON_TAP');
                              logFirebaseEvent('uploadImage_bottom_sheet');
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    '07XXXXXXXX - Giga,  Riara Rd off Ngong',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .headlineSmall
                                    .override(
                                      fontFamily: 'Readex Pro',
                      ...
                      return Row(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'EDIT_PROPERTY_1_PAGE_NEXT_BTN_ON_TAP');
