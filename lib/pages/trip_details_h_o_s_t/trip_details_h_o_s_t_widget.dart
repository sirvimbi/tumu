...
class _TripDetailsHOSTWidgetState extends State<TripDetailsHOSTWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'tripDetailsHOST'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('TRIP_DETAILS_H_O_S_T_arrow_back_rounded_');
        ...
        actions: [
          Visibility(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('TRIP_DETAILS_H_O_S_T_more_vert_outlined_');
                ...
                children: [
                        ...
                        Container(
                          ...
                          child: Align(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'TRIP_DETAILS_H_O_S_T_Image_30cfp212_ON_T');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'TRIP_DETAILS_H_O_S_T_propertyAddress_ON_');
                        logFirebaseEvent('propertyAddress_navigate_to');
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'TRIP_DETAILS_H_O_S_T_info_outlined_ICN_O');
                                    logFirebaseEvent('IconButton_bottom_sheet');
                                    await showModalBottomSheet(
                                      isScrollControlled: true,
                                      backgroundColor: Colors.transparent,
                    ...
                    Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              'Mark this Gig as complete below.',
                        ...
                        if (!widget.tripRef!.complete)
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'TRIP_DETAILS_H_O_S_T_chatGuest_ON_TAP');
                                logFirebaseEvent('chatGuest_backend_call');
                        ...
                        children: [
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'TRIP_DETAILS_H_O_S_T_chatHost_ON_TAP');
                                logFirebaseEvent('chatHost_navigate_to');
