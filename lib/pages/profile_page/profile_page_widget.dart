                ...
                children: [
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('PROFILE_Container_u2tnte10_ON_TAP');
                        logFirebaseEvent('Container_navigate_to');
                    ...
                    if (columnUsersRecord.isHost)
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'PROFILE_Container_e7hz86xy_ON_TAP');
                            logFirebaseEvent('Container_navigate_to');
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('PROFILE_Container_5egs3kf5_ON_TAP');
                          logFirebaseEvent('Container_navigate_to');
                ...
                child: Column(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'PROFILE_PAGE_PAGE_ADD_A_PARTY_BTN_ON_TAP');
